  ...
  return (
    <motion.main initial="hidden" animate="visible" variants={page} className="pt-32">
      <motion.section className="container mx-auto px-6 md:px-12 lg:px-6 py-8 md:py-12 lg:py-16" variants={section} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.25 }}>
        <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-forest font-bold leading-tight">Our Services</h1>
        <p className="mt-6 text-base md:text-lg text-forest/70 max-w-2xl">Comprehensive support for nurses at every stage of their career journey.</p>
      </motion.section>
      ...
      <motion.section className="container mx-auto px-6 md:px-12 lg:px-6 py-8 md:py-12 lg:py-16 bg-cream/50 rounded-3xl" variants={section} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.25 }}>
        <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-forest font-bold">Why Choose NurseConnect?</h2>
