  ...
  return (
    <motion.main initial="hidden" animate="visible" variants={page}>
      ...
      <motion.section className="container mx-auto px-6 py-16" variants={section} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.25 }}>
        <h2 className="font-display text-5xl text-forest">Everything You Need to Land Your Dream Role</h2>
        <p className="mt-4 text-forest/70">From CV submission to interview prep — we support nurses at every stage of their career journey.</p>
      ...
      <motion.section className="container mx-auto px-6 py-16" variants={section} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.25 }}>
        <h3 className="font-display text-4xl text-forest">Nurses Who Found Their Path With Us</h3>
        <div className="mt-8 grid lg:grid-cols-3 gap-6">
